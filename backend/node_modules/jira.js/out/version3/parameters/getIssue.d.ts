export interface GetIssue {
     ...
     */
    expand?: 'renderedFields' | 'name' | 'schema' | 'transitions' | 'editmeta' | 'changelog' | 'versionedRepresentations' | ('renderedFields' | 'name' | 'schema' | 'transitions' | 'editmeta' | 'changelog' | 'versionedRepresentations')[] | string | string[] | GetIssue.Expand | GetIssue.Expand[];
    /**
...
export declare namespace GetIssue {
    enum Expand {
