export interface GetDashboardsPaginated {
     ...
     */
    orderBy?: 'description' | 'favourite_count' | 'id' | 'is_favourite' | 'name' | 'owner' | '+description' | '+favourite_count' | '+id' | '+is_favourite' | '+name' | '+owner' | '-description' | '-favourite_count' | '-id' | '-is_favourite' | '-name' | '-owner' | string;
