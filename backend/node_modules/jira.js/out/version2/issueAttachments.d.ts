...
export declare class IssueAttachments {
     ...
     *   to view the issue.
     */
    getAttachmentContent<T = Buffer>(parameters: Parameters.GetAttachmentContent, callback: Callback<T>): Promise<void>;
    /**
     * Returns the contents of an attachment. A `Range` header can be set to define a range of bytes within the attachment
     * to download. See the [HTTP Range header standard](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Range)
     * for details.
     ...
     *   to view the issue.
     */
    getAttachmentContent<T = Buffer>(parameters: Parameters.GetAttachmentContent, callback?: never): Promise<T>;
    /**
     ...
     *   to view the issue.
     */
    getAttachmentThumbnail<T = Buffer>(parameters: Parameters.GetAttachmentThumbnail, callback: Callback<T>): Promise<void>;
    /**
     * Returns the thumbnail of an attachment.
     *
     * To return the attachment contents, use [Download attachment content](#api-rest-api-2-attachment-content-id-get).
     ...
     *   to view the issue.
     */
    getAttachmentThumbnail<T = Buffer>(parameters: Parameters.GetAttachmentThumbnail, callback?: never): Promise<T>;
    /**
