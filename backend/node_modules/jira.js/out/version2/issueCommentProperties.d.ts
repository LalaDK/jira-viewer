...
export declare class IssueCommentProperties {
     ...
     */
    getCommentPropertyKeys<T = Models.PropertyKeys>(parameters: Parameters.GetCommentPropertyKeys, callback: Callback<T>): Promise<void>;
    /**
     * Returns the keys of all the properties of a comment.
     *
     * This operation can be accessed anonymously.
     ...
     * - If the comment has visibility restrictions, belongs to the group or has the role visibility is restricted to.
     */
    getCommentPropertyKeys<T = Models.PropertyKeys>(parameters: Parameters.GetCommentPropertyKeys, callback?: never): Promise<T>;
    /**
