export interface GetFiltersPaginated {
     ...
     */
    orderBy?: 'description' | 'favourite_count' | 'is_favourite' | 'id' | 'name' | 'owner' | 'is_shared' | '+description' | '+favourite_count' | '+is_favourite' | '+id' | '+name' | '+owner' | '+is_shared' | '-description' | '-favourite_count' | '-is_favourite' | '-id' | '-name' | '-owner' | '-is_shared' | string;
     ...
     */
    expand?: 'description' | 'favourite' | 'favouritedCount' | 'jql' | 'owner' | 'searchUrl' | 'sharePermissions' | 'editPermissions' | 'isWritable' | 'subscriptions' | 'viewUrl' | ('description' | 'favourite' | 'favouritedCount' | 'jql' | 'owner' | 'searchUrl' | 'sharePermissions' | 'editPermissions' | 'isWritable' | 'subscriptions' | 'viewUrl')[] | string | string[] | GetFiltersPaginated.Expand | GetFiltersPaginated.Expand[];
    /**
...
export declare namespace GetFiltersPaginated {
    enum Expand {
