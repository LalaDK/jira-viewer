...
export declare class Tasks {
     ...
     * - Creator of the task.
     */
    getTask<T = Models.TaskProgressObject>(parameters: Parameters.GetTask, callback: Callback<T>): Promise<void>;
    /**
     * Returns the status of a [long-running asynchronous task](#async).
     *
     * When a task has finished, this operation returns the JSON blob applicable to the task. See the documentation of the
     ...
     * - Creator of the task.
     */
    getTask<T = Models.TaskProgressObject>(parameters: Parameters.GetTask, callback?: never): Promise<T>;
    /**
     * Cancels a task.
     *
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** either of:
