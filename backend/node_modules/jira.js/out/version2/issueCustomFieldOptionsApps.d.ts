...
export declare class IssueCustomFieldOptionsApps {
     ...
     */
    getAllIssueFieldOptions<T = Models.PageIssueFieldOption>(parameters: Parameters.GetAllIssueFieldOptions, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of all
     * the options of a select list issue field. A select list issue field is a type of [issue
     * field](https://developer.atlassian.com/cloud/jira/platform/modules/issue-field/) that enables a user to select a
     ...
     * for the app providing the field.
     */
    getAllIssueFieldOptions<T = Models.PageIssueFieldOption>(parameters: Parameters.GetAllIssueFieldOptions, callback?: never): Promise<T>;
    /**
     ...
     */
    getSelectableIssueFieldOptions<T = Models.PageIssueFieldOption>(parameters: Parameters.GetSelectableIssueFieldOptions, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of
     * options for a select list issue field that can be viewed and selected by the user.
     *
     ...
     * Permission to access Jira.
     */
    getSelectableIssueFieldOptions<T = Models.PageIssueFieldOption>(parameters: Parameters.GetSelectableIssueFieldOptions, callback?: never): Promise<T>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of
     ...
     * Permission to access Jira.
     */
    getVisibleIssueFieldOptions<T = Models.PageIssueFieldOption>(parameters: Parameters.GetVisibleIssueFieldOptions, callback: Callback<T>): Promise<void>;
    /**
     * Returns a [paginated](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#pagination) list of
     * options for a select list issue field that can be viewed by the user.
     *
     ...
     * Permission to access Jira.
     */
    getVisibleIssueFieldOptions<T = Models.PageIssueFieldOption>(parameters: Parameters.GetVisibleIssueFieldOptions, callback?: never): Promise<T>;
    /**
     ...
     * for the app providing the field.
     */
    replaceIssueFieldOption<T = unknown>(parameters: Parameters.ReplaceIssueFieldOption, callback: Callback<T>): Promise<void>;
    /**
     * Deselects an issue-field select-list option from all issues where it is selected. A different option can be
     * selected to replace the deselected option. The update can also be limited to a smaller set of issues by using a JQL query.
     *
     ...
     * for the app providing the field.
     */
    replaceIssueFieldOption<T = unknown>(parameters: Parameters.ReplaceIssueFieldOption, callback?: never): Promise<T>;
}
