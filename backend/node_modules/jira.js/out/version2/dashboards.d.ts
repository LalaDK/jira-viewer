...
export declare class Dashboards {
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** None.
     */
    getAllGadgets<T = Models.DashboardGadgetResponse>(parameters: Parameters.GetAllGadgets, callback: Callback<T>): Promise<void>;
    /**
     * Returns a list of dashboard gadgets on a dashboard.
     *
     * This operation returns:
     ...
     * **[Permissions](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#permissions) required:** None.
     */
    getAllGadgets<T = Models.DashboardGadgetResponse>(parameters: Parameters.GetAllGadgets, callback?: never): Promise<T>;
    /**
